...
<div style="display: none">
                ...
                <nav class="header__nav">
                    <ul class="header__my-nav">
                        <li class="header__my-page header__my-page--popular">
                            <a class="header__page-link" href="index.php" title="Популярный контент">
                            ...
                            <ul class="adding-post__tabs-list filters__list tabs__list">
                                <li class="adding-post__tabs-item filters__item">
                                    ...
                                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                                        /**условие на активность таба посла сабмита */
                ...
                <div class="footer__my-info">
                    <ul class="footer__my-pages">
                        ...
                        <li class="footer__my-page footer__my-page--popular">
                            <a class="footer__page-link" href="index.php">Популярный контент</a>
                        </li>
    ...
    <!-- При закомментированных js-скриптах работает отправка фото и переключение табов, работают ссылки с параметрами-->
