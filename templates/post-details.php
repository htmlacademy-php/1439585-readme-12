<main class="page__main page__main--publication">
    <div class="container">
        ...
        <section class="post-details">
            ...
            <?php $postType = "post-" . $postData['category_name']; ?>
                ...
                <div class="post-details__user user">
                    ...
                    <div class="post-details__rating user__rating">
                        <p class="post-details__rating-item user__rating-item user__rating-item--subscribers">
                            <span class="post-details__rating-amount user__rating-amount"><?= $postData['author_subscribers'] ?></span>
                            <span class="post-details__rating-text user__rating-text"><?= showSubscribersCount($postData['author_subscribers']) ?></span>
                        </p>
                        <p class="post-details__rating-item user__rating-item user__rating-item--publications">
                            <span class="post-details__rating-amount user__rating-amount"><?= $postData['author_count_post'] ?></span>
